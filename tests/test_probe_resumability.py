...
class TestProbeResumabilityMetadata:
    ...
    def test_base_probe_supports_resume(self):
        ...
        probe = base.Probe()
        assert hasattr(probe, 'supports_resume'), "Probe should have supports_resume attribute"
        assert probe.supports_resume is True, "Base Probe should support resume by default"

    def test_tree_search_probe_not_resumable(self):
        """Verify TreeSearchProbe does NOT support resume."""
        probe = base.TreeSearchProbe()
        assert hasattr(probe, 'supports_resume'), "TreeSearchProbe should have supports_resume attribute"
        assert probe.supports_resume is False, "TreeSearchProbe should NOT support resume (complex internal state)"
    ...
    def test_iterative_probe_not_resumable(self):
        ...
        assert hasattr(base.IterativeProbe, 'supports_resume'), "IterativeProbe should have supports_resume attribute"
        assert base.IterativeProbe.supports_resume is False, "IterativeProbe should NOT support resume (multi-turn conversations)"
    ...
    def test_custom_probe_inherits_resumability(self):
        ...
        probe = CustomProbe()
        assert probe.supports_resume is True, "Custom probes should inherit supports_resume=True"
    ...
    def test_custom_probe_can_override_resumability(self):
        ...
        assert probe.supports_resume is False, "Custom probes should be able to override supports_resume"
...
class TestIsProbeResumableFunction:
    ...
    def test_iterative_probe_not_resumable(self):
        ...
        assert base.IterativeProbe.supports_resume is False, "IterativeProbe class should have supports_resume=False"
    ...
    def test_probe_without_attribute_defaults_to_resumable(self):
        ...
        result = resumeservice.is_probe_resumable(probe)
        assert result is True, "Probes without supports_resume should default to resumable for backward compatibility"
    ...
    def test_custom_non_resumable_probe(self):
        ...
        result = resumeservice.is_probe_resumable(probe)
        assert result is False, "Custom non-resumable probe should be identified correctly"
...
class TestProbeResumabilityEdgeCases:
    ...
    def test_none_value_for_supports_resume(self):
        ...
        assert result is None or result is False, "None value should be handled gracefully"
...
class TestProbeResumabilityDocumentation:
    ...
    def test_base_probe_class_has_attribute(self):
        ...
        assert hasattr(base.Probe, 'supports_resume'), "Probe class should define supports_resume"
        
        # Check it's a class attribute
        assert 'supports_resume' in base.Probe.__dict__ or \
               any('supports_resume' in cls.__dict__ for cls in base.Probe.__mro__), \
    ...
    def test_tree_search_probe_documents_non_resumability(self):
        ...
        assert hasattr(base.TreeSearchProbe, 'supports_resume'), \
               "TreeSearchProbe should explicitly define supports_resume"
        assert base.TreeSearchProbe.supports_resume is False, \
    ...
    def test_iterative_probe_documents_non_resumability(self):
        ...
        assert hasattr(base.IterativeProbe, 'supports_resume'), \
